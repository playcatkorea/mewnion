      ...
      <main>
        ...
        <section className="relative pt-32 pb-20 px-4 text-center">
          <div
            ...
            style={{
              backgroundImage: `url('https://readdy.ai/api/search-image?query=Exciting%20cat%20events%20and%20activities%20with%20celebration%20atmosphere%2C%20pink%20and%20rose%20lighting%2C%20festive%20modern%20environment%20with%20cats&width=1200&height=600&seq=events-hero&orientation=landscape')`
            }}
          />
          <div className="relative z-10 max-w-4xl mx-auto">
            <h1 className="text-5xl font-bold text-white mb-6" style={{textShadow: '0 0 20px rgba(236, 72, 153, 0.8), 0 0 40px rgba(244, 114, 182, 0.6), 0 4px 8px rgba(0, 0, 0, 0.3)'}}>이벤트</h1>
            <p className="text-xl text-white mb-8 leading-relaxed" style={{textShadow: '0 2px 4px rgba(0, 0, 0, 0.5)'}}>묘연에서 진행하는 다양한 이벤트에 참여해보세요</p>
          </div>
        </section>
